            ...
            <div class="col-10 offset-1">
                <div class="card border-success">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                <img style="border-radius: 50%; height: 200px; width: 200px; margin-left: 20px" class=""
                                    src="<?php echo $pphoto ?>">
                                <hr>
                        ...
                        <div class="row">
                                ...
                                <div class="card border-info">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            ...
                                            <hr>
                                            <button id="changeImage" style="text-align: center"
                                                class="btn btn-sm btn-primary" data-toggle="modal"
                                                data-target=".bd-example-modal-sm">Change Image</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-8">
                                <div class="card border-secondary">
                                    <div class="card-body">
                                        <h3 class="text-canter"><b>Change Your Profile Information: </b></h3>
                                        <hr>

                                        <form class="form" action="change_prf.php?id=<?php echo $ids; ?>" method="post">
                                            ...
                                            <input type="submit" value="Change Information"
                                                class="btn btn-block bg-nav text-light">
                                        </form>
                                        </form>
                                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <h3 class="text-center">Upload New Profile photo</h3>
                                    <hr>
                                </div>
                                <div class="row">
                                    <div class="col-12">
